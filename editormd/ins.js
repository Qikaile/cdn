  ...
  function(module, exports, __webpack_require__) {
    ...
    var render = function render(res) {
      ...
      for (var j = 0, len2 = res.list.length; j < len2; j++) {
        ...
        for (var i = 0, len = data.link.length; i < len; i++) {
          ...
          var minSrc = 'https://raw.sevencdn.com/qikaile/img/master/min_photos/' + data.link[i];
          var src = 'https://raw.sevencdn.com/qikaile/img/master/photos/' + data.link[i];
    ...
    function loadData(success) {
      if (!searchData) {
        ...
        xhr.open('GET', 'https://cdn.jsdelivr.net/gh/qikaile/cdn@1.2/data.json?t=' + +new Date(), true);
